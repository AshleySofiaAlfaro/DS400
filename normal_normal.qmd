...
```{r}
plot_normal_likelihood(y = concussion_subjects$volume, sigma = 0.59) # got 0.59 from the SD
```
...
#sigma is the standard deviation from our data
#y_bar is the mean from our data (fb_concuss)
```
...
**Using Beta-Binomial instead of Gamma-Poisson:**
