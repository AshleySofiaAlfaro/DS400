...
Note to self: \
- Right-skewed = The tail of the distribution is on the right\
- Left-skewed = The tail of the distribution is on the left

α = β: Symmetric w π tending to be around 0.5\
α \> β: Left-skewed
...
Note: More data = more confidence
...
```{r}
plot_beta_binomial(alpha = 110, beta = 2, y = 11, n = 50)
```
